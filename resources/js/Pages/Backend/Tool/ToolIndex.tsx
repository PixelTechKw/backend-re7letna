...
import { PageProps, Tool } from "@/types";
...
export default function ({
    elements,
}: PageProps<{ elements: Tool[] }>): React.ReactNode {
    const {
                            ...
                            <Tooltip>
                                ...
                                >
                                    <p className="text-balance whitespace-pre-line leading-relaxed">
                                        tool will appear on the app in ascending
                                        numerical order (with 1 representing the
                    ...
                    return (
                        ...
                        >
                            <Tooltip>
                                ...
                                >
                                    <p className="text-balance whitespace-pre-line leading-relaxed">
                                        If not active tools can not subscribe to
    ...
    return (
        <AuthenticatedLayout header={capitalize("list of tools")}>
            <div className="w-full flex flex-1 flex-col bg-white  rounded-xl min-h-screen gap-y-4 p-6">
                <div className="flex justify-between items-center">
                    <div className="header-one capitalize">list of tools</div>
                    <Link
                        href={route("backend.tool.create")}
